...
def test_peak_values():
    ...
    assert isinstance(calculations.peak_values(
        potentials_d, currents_d), np.ndarray), "output is not an array"
...
def test_del_potential():
    ...
    np.testing.assert_almost_equal(
        calculations.del_potential(potentials_d, currents_d),
...
def test_half_wave_potential():
    ...
    assert isinstance(
        calculations.half_wave_potential(potentials_d, currents_d)
...
def test_peak_ratio():
    ...
    np.testing.assert_almost_equal(
        calculations.peak_ratio(potentials_d, currents_d),
