...
#  'https://codepen.io/rmarren1/pen/eMQKBW.css']
...
# Uploaded to npm, this can work online now too.
...
app.layout = html.Div(style={'backgroundColor': colors['background']},
    ...
    html.H2(
        children='A Tool for the Analysis of Cyclic Voltammetry Data',
        style={
            'textAlign': 'center',
            'color': colors['text']
            }),
...
def display_files(fileNames):
    if fileNames is not None:
        return html.Ul([html.Li(html.A(x), style={'textAlign': 'center'})
                        for x in fileNames])
...
def update_table1(value):
    ...
    final_dict, x_1, x_2, y_1, y_2, ybase_1, ybase_2, peak_i = data_analysis(
        df)
